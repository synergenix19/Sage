...
def test_draft_templates_are_actually_inert():
    ...
    KNOWN_LIVE_TEMPLATES = {
        ...
        # L2_general_chat_directive removed 2026-06-14: clinical sign-off received, status=approved
        # + approved_by set, so the forcing function is discharged (now covered by
        # test_no_live_template_without_approved_by).
