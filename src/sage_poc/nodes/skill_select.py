...
SEMANTIC_THRESHOLD: float = 0.5416  # calibrated 2026-05-21; gap=0.0083 (lowest hit 0.5474, highest miss 0.5391) — re-run calibrate_threshold.py after any semantic_description edit
