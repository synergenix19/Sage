...
echo "Then MANDATORY convergence via scripts/deploy_converge.sh (deployment-status API + a"
echo "  behavioral probe of the CHANGE ITSELF; never build_sha — three SHA-lie instances 2026-08),"
echo "then the behavioral probe suite + verify crisis_copy_templated,"
