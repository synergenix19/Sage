...
> **⚠️ SUPERSEDED by matrix-v4 (b4d5001a, 2026-07-17, 8/36).** This is the prior full-graph run (7/36, prod 5b33a0e). Correct method, stale SHA — HR was 0/5 here (pre-HR-1). See v4 for the current number.
