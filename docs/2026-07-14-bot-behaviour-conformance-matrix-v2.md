...
> **⚠️ SUPERSEDED FOR HEADLINE by matrix-v4 (`docs/2026-07-17-bot-behaviour-conformance-matrix-v4-fullgraph-b4d5001a.md`).** This v2 headline **10/34** was measured at skill_select ISOLATION, which OVER-COUNTS (it skips intent_route's freeflow gate — the F6-phantom class). The true figure is the FULL-GRAPH number: v3=7/36 (5b33a0e), v4=**8/36** (b4d5001a, current). **Do NOT quote 10/34 as conformance.** Kept for the register rows below (#311/#312/#313/#322), which remain valid.
