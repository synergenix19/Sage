...
- **Generated at:** 2026-07-30T20:42:45+00:00
- **Serving readback:** https://sage-api-production-3328.up.railway.app /health/version
- **Build SHA (from readback):** `2ab5d9a37430bcbdce837da1a15d729d6da622b4` (source: SAGE_BUILD_SHA)
- **Local tree SHA (code measured):** `97c66fdc6bfff188a05fb717009f9ab01ee7ae60`
...
- **Parity note:** NOTE: LOCAL tree 97c66fdc6bff != SERVING build 2ab5d9a37430 — flags are serving-derived but the code under measurement is the local tree; cite accordingly.
...
|---|---|---|---|---|---|---|---|---|
| EMR-S1-000 | s1_active_skill_absorption | 10 | 1.00 | 0.00 | 0.20 | 0.30 | 0 | `skill_continuation|safety_check>intent_route>skill_executor>freeflow_respond>output_gate` |
| EMR-S2-001 | s2_cold_request | 10 | 0.20 | 0.00 | 0.20 | 0.20 | 0 | `info_request|safety_check>intent_route>skill_select>knowledge_retrieve>freeflow_respond>output_gate` |
| EMR-S3-002 | s3_over_pending_offer | 10 | 1.00 | 0.00 | 0.00 | 0.50 | 0 | `new_skill|safety_check>intent_route>offer_accepted>skill_select>offer_promoted>skill_executor>freeflow_respond>output_gate` |
| EMR-PARA-001 | paraphrase | 10 | 1.00 | 1.00 | 0.20 | 0.20 | 0 | `new_skill|safety_check>intent_route>skill_select>skill_matching_rule:default_offer>skill_offer_made>freeflow_respond>output_gate` |
| EMR-PARA-002 | paraphrase | 10 | 1.00 | 1.00 | 0.10 | 0.10 | 0 | `new_skill|safety_check>intent_route>skill_select>skill_matching_rule:default_offer>skill_offer_made>freeflow_respond>output_gate` |
| EMR-PARA-003 | paraphrase | 10 | 1.00 | 0.00 | 0.30 | 0.30 | 0 | `new_skill|safety_check>intent_route>skill_select>skill_matching_rule:default_offer>skill_offer_made>freeflow_respond>output_gate` |
...
| EMR-PARA-005 | paraphrase | 10 | 1.00 | 1.00 | 0.00 | 0.00 | 0 | `new_skill|safety_check>intent_route>skill_select>skill_matching_rule:default_offer>skill_offer_made>freeflow_respond>output_gate` |
| EMR-PARA-006 | paraphrase | 10 | 1.00 | 0.00 | 0.00 | 0.10 | 0 | `new_skill|safety_check>intent_route>skill_select>skill_matching_rule:default_offer>skill_offer_made>freeflow_respond>output_gate` |
| EMR-PARA-007 | paraphrase | 10 | 1.00 | 0.00 | 0.20 | 0.30 | 0 | `new_skill|safety_check>intent_route>skill_select>skill_matching_rule:default_offer>skill_offer_made>freeflow_respond>output_gate` |
| EMR-PARA-008 | paraphrase | 10 | 1.00 | 1.00 | 0.20 | 0.30 | 0 | `new_skill|safety_check>intent_route>skill_select>skill_matching_rule:default_offer>skill_offer_made>freeflow_respond>output_gate` |
| EMR-PARA-009 | paraphrase | 10 | 1.00 | 0.00 | 0.00 | 0.10 | 0 | `new_skill|safety_check>intent_route>skill_select>skill_matching_rule:default_offer>skill_offer_made>freeflow_respond>output_gate` |
...
| EMR-PARA-011 | paraphrase | 10 | 1.00 | 1.00 | 0.00 | 0.10 | 0 | `new_skill|safety_check>intent_route>skill_select>skill_matching_rule:default_offer>skill_offer_made>freeflow_respond>output_gate` |
| EMR-PARA-012 | paraphrase | 10 | 1.00 | 1.00 | 0.20 | 0.20 | 0 | `new_skill|safety_check>intent_route>skill_select>skill_matching_rule:default_offer>skill_offer_made>freeflow_respond>output_gate` |
| EMR-CTRL-001 | control | 10 | 1.00 | 0.00 | 0.00 | 0.00 | 0 | `info_request|safety_check>intent_route>skill_select>knowledge_retrieve_cards>skill_executor>freeflow_respond>output_gate` |
| EMR-CTRL-002 | control | 10 | 0.00 | 0.00 | 0.10 | 0.10 | 0 | `general_chat|safety_check>intent_route>freeflow_respond>output_gate` |
...
- mechanism flip-rate: 0.20 | trajectory flip-rate: 0.30

Mechanism counts (final turn, intent+path signature):

- 8/10 `skill_continuation|safety_check>intent_route>skill_executor>freeflow_respond>output_gate`
- 2/10 `new_skill|safety_check>intent_route>skill_executor>freeflow_respond>output_gate`

Trajectory frequencies (full session):

- 7/10 `t1:general_chat|safety_check>intent_route>freeflow_respond>output_gate ;; t2:info_request|safety_check>intent_route>directive_posture_set>skill_select>knowledge_retrieve_cards>skill_executor>freeflow_respond>output_gate ;; t3:skill_continuation|safety_check>intent_route>skill_executor>freeflow_respond>output_gate`
- 2/10 `t1:general_chat|safety_check>intent_route>freeflow_respond>output_gate ;; t2:info_request|safety_check>intent_route>directive_posture_set>skill_select>knowledge_retrieve_cards>skill_executor>freeflow_respond>output_gate ;; t3:new_skill|safety_check>intent_route>skill_executor>freeflow_respond>output_gate`
...
- 8/10 `info_request|safety_check>intent_route>skill_select>knowledge_retrieve>freeflow_respond>output_gate`
...
- 8/10 `t1:general_chat|safety_check>intent_route>freeflow_respond>output_gate ;; t2:info_request|safety_check>intent_route>skill_select>knowledge_retrieve>freeflow_respond>output_gate`
...
- offer-rate: **1.00** | first-line offer-rate (§1a Tier-1 pair, spec-conformant): **0.00** over n=10
- mechanism flip-rate: 0.00 | trajectory flip-rate: 0.50
...
- 5/10 `t1:new_skill|safety_check>intent_route>skill_select>skill_matching_rule:default_offer>skill_offer_made>freeflow_respond>output_gate ;; t2:new_skill|safety_check>intent_route>offer_accepted>skill_select>offer_promoted>skill_executor>freeflow_respond>output_gate`
- 5/10 `t1:new_skill|safety_check>intent_route>skill_select>skill_matching_rule:default_offer>skill_offer_made>freeflow_respond>output_gate>question_discipline_applied ;; t2:new_skill|safety_check>intent_route>offer_accepted>skill_select>offer_promoted>skill_executor>freeflow_respond>output_gate`
...
- 7/10 `new_skill|safety_check>intent_route>skill_select>skill_matching_rule:default_offer>skill_offer_made>freeflow_respond>output_gate`
- 3/10 `new_skill|safety_check>intent_route>skill_select>skill_matching_rule:default_offer>skill_offer_made>freeflow_respond>output_gate>output_gate_opener_rewritten`
...
- 3/10 `t1:general_chat|safety_check>intent_route>freeflow_respond>output_gate ;; t2:new_skill|safety_check>intent_route>skill_select>skill_matching_rule:default_offer>skill_offer_made>freeflow_respond>output_gate>output_gate_opener_rewritten`
...
- 8/10 `new_skill|safety_check>intent_route>skill_select>skill_matching_rule:default_offer>skill_offer_made>freeflow_respond>output_gate`
- 1/10 `new_skill|safety_check>intent_route>skill_select>skill_matching_rule:default_offer>skill_offer_made>freeflow_respond>output_gate>output_gate_opener_rewritten`
- 1/10 `new_skill|safety_check>intent_route>skill_select>skill_matching_rule:default_offer>skill_offer_made>freeflow_respond>output_gate>output_gate_opener_suppressed_sensitive`

Trajectory frequencies (full session):

- 7/10 `t1:general_chat|safety_check>intent_route>freeflow_respond>output_gate ;; t2:new_skill|safety_check>intent_route>skill_select>skill_matching_rule:default_offer>skill_offer_made>freeflow_respond>output_gate`
- 1/10 `t1:general_chat|safety_check>intent_route>freeflow_respond>output_gate ;; t2:new_skill|safety_check>intent_route>skill_select>skill_matching_rule:default_offer>skill_offer_made>freeflow_respond>output_gate>output_gate_opener_rewritten`
- 1/10 `t1:general_chat|safety_check>intent_route>freeflow_respond>output_gate>output_gate_opener_rewritten ;; t2:new_skill|safety_check>intent_route>skill_select>skill_matching_rule:default_offer>skill_offer_made>freeflow_respond>output_gate>output_gate_opener_suppressed_sensitive`
- 1/10 `t1:general_chat|safety_check>intent_route>freeflow_respond>output_gate>output_gate_opener_rewritten ;; t2:new_skill|safety_check>intent_route>skill_select>skill_matching_rule:default_offer>skill_offer_made>freeflow_respond>output_gate`
...
- 8/10 `t1:general_chat|safety_check>intent_route>freeflow_respond>output_gate ;; t2:new_skill|safety_check>intent_route>skill_select>skill_matching_rule:default_offer>skill_offer_made>freeflow_respond>output_gate`
- 1/10 `t1:general_chat|safety_check>intent_route>freeflow_respond>output_gate>output_gate_opener_rewritten ;; t2:new_skill|safety_check>intent_route>skill_select>skill_matching_rule:default_offer>skill_offer_made>freeflow_respond>output_gate>output_gate_opener_rewritten`
- 1/10 `t1:general_chat|safety_check>intent_route>freeflow_respond>output_gate ;; t2:new_skill|safety_check>intent_route>skill_select>skill_matching_rule:default_offer>skill_offer_made>freeflow_respond>output_gate>question_discipline_applied`
...
- 10/10 `t1:general_chat|safety_check>intent_route>freeflow_respond>output_gate ;; t2:info_request|safety_check>intent_route>skill_select>knowledge_retrieve_cards>skill_executor>freeflow_respond>output_gate`
...
- 9/10 `general_chat|safety_check>intent_route>freeflow_respond>output_gate`
- 1/10 `general_chat|safety_check>intent_route>freeflow_respond>output_gate>output_gate_opener_rewritten`

Trajectory frequencies (full session):

- 9/10 `t1:general_chat|safety_check>intent_route>freeflow_respond>output_gate`
- 1/10 `t1:general_chat|safety_check>intent_route>freeflow_respond>output_gate>output_gate_opener_rewritten`
